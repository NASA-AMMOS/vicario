...
/**
	...
	**/
    ...
    if (jadeDisplay != null) {
    	...
    	// DisplayJAI (from jai_core) replaces the old jpl.mipl.jade.JadeDisplay.
    	// It's a JPanel that directly renders a RenderedImage.
    	jadeDisplay = new DisplayJAI(im);
    	scrollPane = new JScrollPane(jadeDisplay);
