...
//	 use to determine the format of the input data file
    ...
    // used to determine if an output detached label should include FILE_RECORDS
...
//		 String inputFileName; // used by the writer to put the filename into the label
	public String getInputFileFullPath() {
	  ...
	  public void setInputFileFullPath(String _inputFileFullPath) {
			inputFileFullPath = _inputFileFullPath;
		}
...
//	 PDS detached label support
	...
	public void setExtraFileType(String s) {
		extraFileType = s;
	}
	...
	public void setExtraFilename(String s) {
		extraFilename = s;
	}
	...
	sb.append("inputFileFullPath = "+inputFileFullPath+"\n");
