...
public class VicarMetadata extends IIOMetadata implements Cloneable {
    ...
    public static final String
        extraImageMetadataFormatClassName = "jpl.mipl.io.plugins.PDSMetadataFormat";
    ...
    public static final String[] metadataFormatNames = {
        ...
        extraImageMetadataFormatName
    };
    
    public static final String[] extraMetadataFormatNames = {  extraImageMetadataFormatName } ;
    public static final String[] extraMetadataFormatClassNames = { extraImageMetadataFormatClassName } ;
    ...
    org.w3c.dom.Document extraDoc = null;
...
// Build IIOMetadataFormat classes for my formats
    ...
    public Node getAsTree(String formatName) {
        ...
        } else if (formatName.equals(extraImageMetadataFormatName)) {   
        	return getExtraTree();
        }else {
            throw new IllegalArgumentException("Not a recognized format!");
        }  
   ...
   */
     ...
     *
     * create or return the tree
     * the extra tree is a Document
     * look at VicarMetadata getNativeTree()
     */
  
      private Node getExtraTree() {
          
      	if (debug) System.out.println("PDSMetadata.getExtraTree() "+extraDoc);
          return extraDoc; // Document is a subclass of Node
      }
    ...
    *************************/
    public void setFromTree(String formatName, Node root) {
        ...
        //  do something with the "common" metaData
            ...
            //  extra label Document
                extraDoc = (Document) root;
        } else {
            throw new IllegalArgumentException("Not a recognized format!");
        }
