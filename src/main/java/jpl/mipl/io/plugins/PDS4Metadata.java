/*
 * @(#)PDS4Metadata.java	1.0 01/15/2014
 *
 * PDS4 metadata.
 * The PDS4 label is XML 
 * The PDS4 metadata the xml label
 * The XML in the label will be converted to a DOM Document to be stored here
 * The String is not stored here (or anywhere currently)
 */
 ...
 * If the "common" IIOMetadataNode version of the metedata is requested it will then be built
 ...
 */
public class PDS4Metadata extends IIOMetadata implements Cloneable {

    // package scope
    public static final String 
        dtd = "pds_label.dtd";
    // what should this be for pds4 - probably a schema somewhere in PDS land
    ...
    public static final String nativeImageMetadataFormatName = "PDS4_LABEL";    
      //   nativeImageMetadataFormatName = "jpl.mipl.io.plugins.pdsimage";    
        // this isn't defined yet - this is a placeholder
        
        public static final String 
        nativeImageMetadataFormatClassName = "jpl.mipl.io.plugins.PDS4MetadataFormat";
     ...
     // org.apache.xerces.dom.DocumentImpl
        ...
        /**
         * this would be the vicar metadata if the input file is either a
         * Dualie. PDS with san embedded vicar label or a PDS4 detached label
         * pointing to a vicar image file
         */
        ...
        // should Table be any different than Image?  They might have different contents but they should be the same structure
        public static final String nativeTableMetadataFormatName = "PDS4_LABEL" ; // ??? TABLE
        public static final String nativeTableMetadataFormatClassName  = "jpl.mipl.io.plugins.PDS4MetadataFormat";
        
        // PDSMetadata.nativeTableMetadataFormatName
        // PDSMetadata.nativeTableMetadataFormatClassName
 ...
 public PDS4Metadata(IIOMetadata metadata) {
 	...
 	public PDS4Metadata(Document doc) {
...
// Build IIOMetadataFormat classes for my formats
    ...
    public Node getAsTree(String formatName) {
    	...
    	if (debug) System.out.println("PDS4Metadata.getAsTree() "+formatName);
        if (formatName.equals(nativeMetadataFormatName)) {
   ...
   */
    private Node getNativeTree() {
    	...
    	if (debug) System.out.println("PDS4Metadata.getNativeTree() "+nativeDoc);
   ...
   */
    ...
    * for PDS4Metadata to hold.
    *
    *************************/
    public void setFromTree(String formatName, Node root) {
        if (debug) {
        	System.out.println("PDS4Metadata.setFromTree() "+formatName+" *************************************");
        	System.out.println("PDS4Metadata.setFromTree() root "+root+" *************************************");
        }
	 ...
	 * Will be set by PDS4InputFile when this metadata object is created
	 * @param size
	 */
	...
	/**
	 * get the value for the image label(s) size in bytes
