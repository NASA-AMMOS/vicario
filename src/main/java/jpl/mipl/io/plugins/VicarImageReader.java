    ...
    private void readHeader(ImageReadParam param) throws IIOException {
        ...
        try
        {
	       ...
	       if (format.equals("HALF") && org.equals("BSQ") && nb == 1) {
                ...
                //important to use something like tile dimensions here not full image dimensions
                //otherwise very large images will cause a crash
                //(and I'm pretty sure the actual dimensions used here don't really matter for anything)
                //See issue #110
                SampleModel sampleModel = vif.createSampleModel();
