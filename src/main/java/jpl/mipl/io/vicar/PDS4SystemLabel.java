...
public class PDS4SystemLabel extends SystemLabel {
    ...
    ****/
	...
	/* input may be many pds4 types stored in a File_Area_Observational
	 * we only handle Array_ (image types)
	 * and
	 * Table_ (Table types)
	 */
	String _File_Area_Observational_type = "";
	// table related values. a few are shared between table and arrays
	// shared values:
	// <File> <file_name> _detachedFilename ="";
 ...
 */
 ...
 // Image File,bytes (size)
    ...
    // new 6-26-18 to support new PDS4  <disp:Display_Settings>
    // primarlily used for FITS
    public void setFlip_image_vertical(boolean b) {
    	_flip_image_vertical = b;
    }
    public boolean getFlip_image_vertical() {
    	return _flip_image_vertical ;
    }
    
    public void setFlip_image_horizontal(boolean b) {
    	_flip_image_horizontal = b;
    }
     ...
     */
        public String toString()
        {
        	...
        	// add some items 
        	s = s+"\n_File_Area_Observational_type = "+_File_Area_Observational_type ;
        	s = s+"\n_detachedFilename = "+_detachedFilename ;
        	return s;
        }
