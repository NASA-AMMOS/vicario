 ...
 * <li>X86-64-LINX: 64-bit Intel x86 machine running Linux
 * <li>X86-SOLR*: Intel x86 machine running Solaris 2
 * <li>PPC-LINUX*: PowerPC machine running Linux
 * <li>MAC-OSX*: Macintosh running Mac OS X (PowerPC)
 * <li>X86-MACOSX: Macintosh running Mac OS X (Intel)
 * <li>MAC64-OSX: Macintosh running Mac OS X (64-bit)
 * <li>X86-NT*: Intel x86 machine running Windows NT
 * <li>AARCH64-LNX: ARM64 machine running Linux (e.g., AWS Graviton)
 * </ul>
 ...
 *     X86-SOLR, DECSTATN, AXP-UNIX, AXP-LINUX, X86-LINUX, X86-64-LINX,
 *     X86-MACOSX, MAC64-OSX, X86-NT, AARCH64-LNX.
 ...
 *     AXP-UNIX, AXP-LINUX, X86-LINUX, X86-64-LINX, X86-MACOSX, MAC64-OSX,
 *     X86-NT, AARCH64-LNX.
